          ...
          children: [
                ...
                child: Padding(
                  ...
                  child: SizedBox(
                    width: MediaQuery.of(context)
                        .size
                        .width, // Make width stretch across the screen
                    height: 70.0, // Set a fixed height for the text box
                    child: FittedBox(
                      fit: BoxFit.fitWidth,
                      child: Text(
                        title!,
            ...
            Column(
              ...
              children: [
                ...
                if (title == null) Image.asset(imageAsset, height: 300),
                SizedBox(height: 50),
                if (title != null)
                  Text(
                    subtitle,
            ...
            if (title != null) SizedBox(height: 90),
            if (title != null)
              ConstrainedBox(
