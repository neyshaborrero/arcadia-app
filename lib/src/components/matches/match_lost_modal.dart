...
class MatchLostModal extends StatefulWidget {
  final FirebaseService firebaseService;

  const MatchLostModal({super.key, required this.firebaseService});

  @override
  _MatchLostModalState createState() => _MatchLostModalState();
}

class _MatchLostModalState extends State<MatchLostModal> {
